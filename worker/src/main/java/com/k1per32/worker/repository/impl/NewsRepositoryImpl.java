package com.k1per32.worker.repository.impl;
...
public class NewsRepositoryImpl implements NewsRepository {
    ...
    public Mono<Boolean> saveNews(String date, Object newsObject) throws JsonProcessingException {
        Duration tt1 = Duration.ofHours(1);
        ObjectMapper objectMapper = new ObjectMapper();
        return redisOperations.opsForValue().set(date, objectMapper.readTree(newsObject.toString()), tt1);
